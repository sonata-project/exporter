...
namespace Exporter\Test\Integration\Writer;
...
{
    /**
     * @var string relative path to the test file
     */
    private $filename;
    ...
    {
        $writer = new KnpSnappyWriter($this->pdfGenerator, $this->filename, $this->wkhtmltopdf, false);
        $writer->open();
    ...
    {
        $writer = new KnpSnappyWriter($this->pdfGenerator, $this->filename, $this->wkhtmltopdf, true, false);
    ...
    public function testWithBorders()
    {
        ...
        $writer = new KnpSnappyWriter($this->pdfGenerator, $this->filename, $this->wkhtmltopdf, false, true);
    ...
    {
        $borderedStyle = '<style>table{border-collapse:collapse;width:90%;}th,td{border:1px solid black;}</style>';
        $writer = new KnpSnappyWriter($this->pdfGenerator, $this->filename, $this->wkhtmltopdf, false, false);
